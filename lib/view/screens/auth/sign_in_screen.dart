...
//                               children: [
//                                 Image.asset(Images.logo_dark, width: 170),
...
//                                 // Align(
//                                 //   alignment: Get.find<LocalizationController>().isLtr ? Alignment.topCenter : Alignment.topCenter,
...
class SignInScreenState extends State<SignInScreen> {
      ...
      body: Stack(
        children: [
          ...
          Padding(
            ...
            child: SingleChildScrollView(
                child: Image.asset(Images.logo_dark, height: 200, width: 200)),
          ),
          Center(
            child: Scrollbar(
              child: SingleChildScrollView(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(Images.mob_bg),
                                fit: BoxFit.cover,
                              ),
                            ),
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Sign In Text Heading with Underline
                                  Text(
                                    'SIGN IN',
                                    style: TextStyle(
                                      fontSize: 15,
                                  ...
                                  SizedBox(
                                      height:
                                          5), // Space between text and underline
                                  Container(
                                    height: 4,
                                    width: 50,
                                    color: Colors.black,
                                  ...
                                  SizedBox(
                                      height: 40), // Space after the underline
                                  CustomTextField(
                                    titleText: 'phone'.tr,
                                    controller: _phoneController,
                                    inputType: TextInputType.phone,
  ...
  void _login(String countryCode) async {
    String phone = _phoneController.text.trim();
    ...
    if (phone.isEmpty) {
      ...
      Get.find<AuthController>().forgetPassword(numberWithCountryCode).then((value) {
        if (value.isSuccess) {
          ...
          Get.back();
          // Get.toNamed(RouteHelper.getSignUpRoute());
          Get.to(SignUpScreen(number: numberWithCountryCode,));
        }
        else {
