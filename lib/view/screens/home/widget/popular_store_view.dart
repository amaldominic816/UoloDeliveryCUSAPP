      ...
      return (storeList != null && storeList.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
              title: isFeatured ? 'Popular Stores'.tr : isPopular ? Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
                        ...
                        Stack(children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              ...
                              height: 65, width: 130, fit: BoxFit.cover,
                            ),
                          ),
                          DiscountTag(
