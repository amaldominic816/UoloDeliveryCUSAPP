                  ...
                  child: SingleChildScrollView(
                    child: Stack(
                      children: [
                        ...
                        Padding(
                          padding: ResponsiveHelper.isDesktop(context) ? const EdgeInsets.all(50) : EdgeInsets.zero,
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            CustomButton(
                              height: ResponsiveHelper.isDesktop(context) ? 45 : null,
                              width:  ResponsiveHelper.isDesktop(context) ? 180 : null,
                              buttonText: ResponsiveHelper.isDesktop(context) ? 'login' : 'Current users, sign in here.'.tr,
                              onPressed: () => Get.toNamed(RouteHelper.getForgotPassRoute(false, null)),
                              isLoading: authController.isLoading,
                              radius: ResponsiveHelper.isDesktop(context) ? Dimensions.radiusSmall : Dimensions.radiusDefault,
                              isBold: !ResponsiveHelper.isDesktop(context),
                            ...
                            CustomButton(
                              height: ResponsiveHelper.isDesktop(context) ? 45 : null,
                              width:  ResponsiveHelper.isDesktop(context) ? 180 : null,
                              buttonText: ResponsiveHelper.isDesktop(context) ? 'login' : 'Dont have an account? CREATE ONE!'.tr,
