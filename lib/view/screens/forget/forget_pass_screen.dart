...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.fromSocialLogin ? 'phone'.tr : 'Enter Your Number'.tr),
        ...
        child: FooterView(child: Container(
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Text('Please Enter your Phone Number', style: robotoRegular, textAlign: TextAlign.center),
            ),
