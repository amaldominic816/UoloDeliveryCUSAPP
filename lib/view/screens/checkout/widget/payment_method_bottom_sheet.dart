...
class _PaymentMethodBottomSheetState extends State<PaymentMethodBottomSheet> {
  ...
  void initState() {
    ...
    // Set the default payment method to Cash on Delivery (COD)
    Get.find<OrderController>().setPaymentMethod(0);
  }
                      ...
                      children: [
                        ...
                        widget.storeId == null && widget.isDigitalPaymentActive && notHideDigital
                            ...
                            itemBuilder: (context, index) {
                              bool isSelected = orderController.paymentMethodIndex == 2 &&
                                  Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay! == orderController.digitalPaymentName;
                              return InkWell(
                                onTap: () {
